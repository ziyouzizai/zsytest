...
public class HttpUtil {
    ...
    public static String doGet(String url,String charset) {
    	byte[] bytes = HttpUtil.doGet(url , null , null , 0);
        try {
     ...
     * 
     */
    public static byte[] doGet(String url , Map<String,? extends Object> headerMap) {
     ...
     * @modify 窦海宁, 2012-03-19
     */
    public static byte[] doGet(String url , Map<String,? extends Object> headerMap , String proxyUrl , int proxyPort) {
        ...
        if (headerMap != null) {
            ...
            if (headerMap != null) {
                ...
                while (iterator.hasNext()) {
                    ...
                    getMethod.addRequestHeader(key,headerMap.get(key).toString());
                }
            }
        }
     ...
     * 
     */
    public static byte[] doPost(String url , Map<String,? extends Object> parameterMap) {
     ...
     */
    public static byte[] doPost(String url , Map<String,? extends Object> parameterMap , String paramCharset) {
    ...
    public static String post(String url,Map<String,? extends Object> parameterMap,String charset) {
    	byte[] bytes = doPost(url,parameterMap,charset);
    	String result = null;
    	try {
     ...
     * @modify 窦海宁, 2012-05-21
     */
    public static byte[] doPost(String url , Map<String,? extends Object> headerMap , Map<String,? extends Object> parameterMap , String paramCharset) {
     ...
     * 
     */
    public static byte[] doPost(String url , Map<String,? extends Object> parameterMap , String paramCharset , String proxyUrl , int proxyPort) {
     ...
     * @return 与当前请求对应的响应内容字节数组
     */
    public static byte[] doPost(String url , Map<String,? extends Object> headerMap , Map<String,? extends Object> parameterMap , String paramCharset , String proxyUrl , int proxyPort) {
        byte[]     content    = null;
        HttpClient httpClient = new HttpClient();
        ...
        if (headerMap != null) {
            ...
            if (headerMap != null) {
                ...
                while (iterator.hasNext()) {
                	String key = iterator.next();
                    postMethod.addRequestHeader(key,headerMap.get(key).toString());
                }
            }
        }
